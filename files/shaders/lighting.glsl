...
#if PER_PIXEL_LIGHTING
    lightResult.xyz += diffuseLight * shadowing - diffuseLight; // This light gets added a second time in the loop to fix JDGBOLT's slowdown, so we need to negate its contribution here.
#else

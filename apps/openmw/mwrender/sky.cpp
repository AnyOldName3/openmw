...
public:
    ...
    Moon(osg::Group* parentNode, Resource::ImageManager& imageManager, float scaleFactor, Type type)
        : CelestialBody(parentNode, scaleFactor, Mask_Sun)
        , mType(type)
    ...
    , mSunEnabled(true)
{
    ...
    skyroot->setNodeMask(Mask_Sky | Mask_Sun | Mask_WeatherParticles);
...
void SkyManager::setEnabled(bool enabled)
{
    ...
    mRootNode->setNodeMask(enabled ? Mask_Sky|Mask_Sun|Mask_WeatherParticles : 0);
